        ...
        <View style={styles.wraper}>
          <View style={{marginVertical: 0}}>
            ...
            <View>
              ...
              <View>
                <TouchableOpacity
                  onPress={() => Linking.openURL('tel:+917419197878')}
                  style={{marginLeft: 60}}>
                ...
                <TouchableOpacity
                  onPress={() => Linking.openURL('tel:+919570424242')}
                  style={{
                    borderBottomWidth: 2,
                  ...
                  <Text style={styles.btnText1}>
                    <Text style={{fontWeight: 500}}>Alternative Number : </Text>{' '}
                    9570424242
                  </Text>
                </TouchableOpacity>
                <TouchableOpacity
                  ...
                  onPress={() =>
                    Linking.openURL('mailto: contact@therightguru.com')
                  }>
                  <Text style={styles.btnText1}>
                ...
                <TouchableOpacity
                  ...
                  <Text style={styles.btnText1}>
                    <Text style={{fontWeight: 500}}>
                      Address: 311 T/F Vardhman Sunder Plaza, MLU Plot No 12
